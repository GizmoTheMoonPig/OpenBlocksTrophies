...
public class TrophyGenerator extends TrophyProvider {
	...
	protected void createTrophies() {
		...
		this.makeTrophy(new Trophy.Builder(EntityType.VILLAGER).addRegistry("profession", Registries.VILLAGER_PROFESSION).build());
		...
		this.makeTrophy(new Trophy.Builder(EntityType.RABBIT).setScale(2.0F).setRightClickBehavior(new ItemDropBehavior(Items.CARROT, 20000))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.BROWN.ordinal()))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.WHITE.ordinal()))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.BLACK.ordinal()))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.WHITE_SPLOTCHED.ordinal()))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.GOLD.ordinal()))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.SALT.ordinal()))
				.addVariant("RabbitType", String.valueOf(Rabbit.Variant.EVIL.ordinal())).build());
		...
		this.makeTrophy(new Trophy.Builder(EntityType.ZOMBIE_VILLAGER).addRegistry("profession", Registries.VILLAGER_PROFESSION).build());
		...
		this.makeTrophy(new Trophy.Builder(EntityType.TROPICAL_FISH).setScale(2.0F)
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.KOB, DyeColor.ORANGE, DyeColor.WHITE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.SUNSTREAK, DyeColor.GRAY, DyeColor.WHITE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.KOB, DyeColor.RED, DyeColor.WHITE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.BLOCKFISH, DyeColor.RED, DyeColor.WHITE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.BETTY, DyeColor.RED, DyeColor.WHITE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.CLAYFISH, DyeColor.WHITE, DyeColor.ORANGE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.BRINELY, DyeColor.LIME, DyeColor.LIGHT_BLUE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.SPOTTY, DyeColor.PINK, DyeColor.LIGHT_BLUE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.FLOPPER, DyeColor.WHITE, DyeColor.YELLOW)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.SPOTTY, DyeColor.WHITE, DyeColor.YELLOW)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.FLOPPER, DyeColor.YELLOW, DyeColor.YELLOW)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.DASHER, DyeColor.CYAN, DyeColor.YELLOW)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.BLOCKFISH, DyeColor.PURPLE, DyeColor.YELLOW)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.DASHER, DyeColor.CYAN, DyeColor.PINK)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.GLITTER, DyeColor.WHITE, DyeColor.GRAY)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.CLAYFISH, DyeColor.WHITE, DyeColor.GRAY)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.STRIPEY, DyeColor.ORANGE, DyeColor.GRAY)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.FLOPPER, DyeColor.GRAY, DyeColor.GRAY)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.SUNSTREAK, DyeColor.BLUE, DyeColor.GRAY)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.FLOPPER, DyeColor.GRAY, DyeColor.BLUE)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.CLAYFISH, DyeColor.WHITE, DyeColor.RED)))
				.addVariant("Variant", String.valueOf(TropicalFish.packVariant(TropicalFish.Pattern.SNOOPER, DyeColor.GRAY, DyeColor.RED))).build());
		...
		this.makeTrophy(new Trophy.Builder(EntityType.CAT).setScale(1.25F).setRightClickBehavior(new PullFromLootTableBehavior(BuiltInLootTables.CAT_MORNING_GIFT, 20000))
				.addRegistry("variant", Registries.CAT_VARIANT).build());
		...
		this.makeTrophy(new Trophy.Builder(EntityType.PANDA).setScale(0.75F).setRightClickBehavior(new ItemDropBehavior(Items.BAMBOO, 20000))
				.addVariant(Map.of("MainGene", Panda.Gene.NORMAL.getSerializedName(), "HiddenGene", Panda.Gene.NORMAL.getSerializedName()))
				.addVariant(Map.of("MainGene", Panda.Gene.AGGRESSIVE.getSerializedName(), "HiddenGene", Panda.Gene.AGGRESSIVE.getSerializedName()))
				.addVariant(Map.of("MainGene", Panda.Gene.LAZY.getSerializedName(), "HiddenGene", Panda.Gene.LAZY.getSerializedName()))
				.addVariant(Map.of("MainGene", Panda.Gene.WORRIED.getSerializedName(), "HiddenGene", Panda.Gene.WORRIED.getSerializedName()))
				.addVariant(Map.of("MainGene", Panda.Gene.PLAYFUL.getSerializedName(), "HiddenGene", Panda.Gene.PLAYFUL.getSerializedName()))
				.addVariant(Map.of("MainGene", Panda.Gene.WEAK.getSerializedName(), "HiddenGene", Panda.Gene.WEAK.getSerializedName()))
				.addVariant(Map.of("MainGene", Panda.Gene.BROWN.getSerializedName(), "HiddenGene", Panda.Gene.BROWN.getSerializedName())).build());
		...
		this.makeTrophy(new Trophy.Builder(EntityType.FROG).setScale(1.5F).setRightClickBehavior(new ItemDropBehavior(Items.SLIME_BALL, 20000))
				.addRegistry("variant", Registries.FROG_VARIANT).build());
