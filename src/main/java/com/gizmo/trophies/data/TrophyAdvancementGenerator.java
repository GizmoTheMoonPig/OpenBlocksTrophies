...
public class TrophyAdvancementGenerator implements AdvancementProvider.AdvancementGenerator {
	...
	public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer, ExistingFileHelper helper) {
		...
		Advancement.Builder.advancement().parent(oneTrophy).display(
			...
			.addCriterion("has_wither_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.WITHER)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
			.addCriterion("has_dragon_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.ENDER_DRAGON)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
			.addCriterion("has_elder_guardian_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.ELDER_GUARDIAN)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
			.addCriterion("has_evoker_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.EVOKER)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
			.addCriterion("has_warden_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.WARDEN)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
			.addCriterion("has_ravager_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.RAVAGER)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
			.addCriterion("has_piglin_brute_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.PIGLIN_BRUTE)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
		...
		Advancement.Builder.advancement().parent(oneTrophy).display(
				...
				null, AdvancementType.CHALLENGE, true, true, false)
			.addCriterion("has_blue_axolotl_trophy", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.AXOLOTL, this.makeIntVariant(4))).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()))
	...
	private Advancement.Builder addEveryVanillaMob(HolderGetter<Item> getter, Advancement.Builder builder) {
		for (EntityType<?> type : BuiltInRegistries.ENTITY_TYPE.stream().filter(type -> BuiltInRegistries.ENTITY_TYPE.getKey(type).getNamespace().equals("minecraft") && !OpenBlocksTrophies.UNUSED_TYPES.contains(type)).toList()) {
			...
			if (instance != null && Mob.class.isAssignableFrom(instance)) {
				builder.addCriterion(BuiltInRegistries.ENTITY_TYPE.getKey(type).getPath(), InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(type)).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()));
			}
		}
		return builder;
	}
	...
	private Advancement.Builder makeCommonFish(HolderGetter<Item> getter, Advancement.Builder builder) {
		for (TropicalFish.Variant variant : TropicalFish.COMMON_VARIANTS) {
			...
			builder.addCriterion(fishName, InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().hasComponents(DataComponentPredicate.builder().expect(TrophyRegistries.TROPHY_INFO.get(), new TrophyInfo(EntityType.TROPICAL_FISH, this.makeIntVariant(variant.getPackedId()))).build()).of(getter, TrophyRegistries.TROPHY_ITEM).build()));
		}
		return builder;
	}
