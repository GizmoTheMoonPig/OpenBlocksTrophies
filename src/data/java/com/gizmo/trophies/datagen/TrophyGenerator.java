...
public class TrophyGenerator extends TrophyProvider {
	...
	protected void createTrophies(HolderLookup.Provider provider) {
		...
		this.makeTrophy(new Trophy.Builder(EntityType.VILLAGER).addRegistryVariant("profession", Registries.VILLAGER_PROFESSION.identifier()));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.GHAST).setOffset(0.0F, 0.35F, 0.0F).setScale(0.25F));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.SQUID).setOffset(0.0F, 0.5F, 0.0F).setRightClickBehavior(new PlaceBlockBehavior(Blocks.WATER, PlaceBlockBehavior.PlacementMethod.ABOVE)));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.RABBIT).setScale(1.5F).setRightClickBehavior(new ItemDropBehavior(Items.CARROT, 20000))
		...
		this.makeTrophy(new Trophy.Builder(EntityType.STRAY).setRightClickBehavior(new ShootProjectileBehavior(new ItemStackTemplate(Items.TIPPED_ARROW, DataComponentPatch.builder().set(DataComponents.POTION_CONTENTS, new PotionContents(Potions.SLOWNESS)).build()), 1, true, Optional.of(SoundEvents.ARROW_SHOOT))));
		this.makeTrophy(new Trophy.Builder(EntityType.HUSK).setRightClickBehavior(new ItemDropBehavior(Items.FEATHER, 20000)));
		this.makeTrophy(new Trophy.Builder(EntityType.ZOMBIE_VILLAGER).addRegistryVariant("profession", Registries.VILLAGER_PROFESSION.identifier()));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.PIGLIN).setRightClickBehavior(new ClickWithItemBehavior(Ingredient.of(provider.getOrThrow(Tags.Items.INGOTS_GOLD)), true, new PullFromLootTableBehavior(BuiltInLootTables.PIGLIN_BARTERING, 0), 200, SoundEvents.PIGLIN_ADMIRING_ITEM)));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.AXOLOTL).setScale(1.25F).addLoadCondition(new NotCondition(new ModLoadedCondition("mavm")))
		...
		this.makeTrophy(new Trophy.Builder(EntityType.GLOW_SQUID).setOffset(0.0F, 0.5F, 0.0F).setRightClickBehavior(new MobEffectBehavior(MobEffects.GLOWING, 200, 0)));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.WITHER).setDropChance(0.0075D).setOffset(0.0F, -0.2F, 0.0F).setScale(0.75F));
		this.makeTrophy(new Trophy.Builder(EntityType.ENDER_DRAGON).setDropChance(0.0075D).setRotation(0.0F, 180.0F, 0.0F).setScale(0.25F).setRightClickBehavior(new ClickWithItemBehavior(Items.GLASS_BOTTLE, true, new ItemDropBehavior(Items.DRAGON_BREATH))));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.BREEZE).setRightClickBehavior(new ShootProjectileBehavior(new ItemStackTemplate(Items.WIND_CHARGE), 1, false, Optional.of(SoundEvents.BREEZE_SHOOT))));
		this.makeTrophy(new Trophy.Builder(EntityType.BOGGED).setRightClickBehavior(new ShootProjectileBehavior(new ItemStackTemplate(Items.TIPPED_ARROW, DataComponentPatch.builder().set(DataComponents.POTION_CONTENTS, new PotionContents(Potions.POISON)).build()), 1, true, Optional.of(SoundEvents.ARROW_SHOOT))));
		...
		this.makeTrophy(new Trophy.Builder(EntityType.HAPPY_GHAST).setOffset(0.0F, 0.3F, 0.0F).setScale(0.25F));
		this.makeTrophy(new Trophy.Builder(EntityType.COPPER_GOLEM)
		...
		this.makeTrophy(new Trophy.Builder(EntityType.PARCHED).setRightClickBehavior(new ShootProjectileBehavior(new ItemStackTemplate(Items.TIPPED_ARROW, DataComponentPatch.builder().set(DataComponents.POTION_CONTENTS, new PotionContents(Potions.WEAKNESS)).build()), 1, true, Optional.of(SoundEvents.ARROW_SHOOT))));
		this.makeTrophy(new Trophy.Builder(EntityType.CAMEL_HUSK).setScale(0.75F));
		this.makeTrophy(new Trophy.Builder(EntityType.NAUTILUS));
		this.makeTrophy(new Trophy.Builder(EntityType.ZOMBIE_NAUTILUS)
