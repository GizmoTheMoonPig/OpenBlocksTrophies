...
public record EmiTrophyRecipe(Identifier id, Trophy trophy, CompoundTag variant) implements EmiRecipe {
	...
	public List<EmiStack> getOutputs() {
		return List.of(EmiStack.of(TrophyItemHelper.loadVariantToTrophy(this.trophy().type(), this.variant())));
	}
